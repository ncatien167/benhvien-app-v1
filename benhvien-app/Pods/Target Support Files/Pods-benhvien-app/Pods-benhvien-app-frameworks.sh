...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ButtonBackgroundColor/ButtonBackgroundColor.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/KASlideShow/KASlideShow.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MBProgressHUD/MBProgressHUD.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Mantle/Mantle.framework"
  install_framework "$BUILT_PRODUCTS_DIR/NSUserDefaults+Utility/NSUserDefaults_Utility.framework"
